  ...
  render() {
    ...
    return (
      <li>
        ...
        <div>
          <button className="btn btn-default btn-sm" {...enableButton(issue.button_delete_branch)} onClick={onDelete.bind(this, issue)}>
            Delete Branch
          </button>
          <button className="btn btn-default btn-sm" {...enableButton(issue.button_close_issue)} onClick={onDelete.bind(this, issue)}>
            Close Issue
          </button>
          <button className="btn btn-default btn-sm" {...enableButton(issue.button_merge_pull_request)} onClick={onDelete.bind(this, issue)}>
            Merge Pull Request
          </button>
          <button className="btn btn-default btn-sm" {...enableButton(issue.button_snooze)} onClick={onDelete.bind(this, issue)}>
            Snooze
          </button>
        </div>
      </li>
